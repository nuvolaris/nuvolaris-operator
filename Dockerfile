...
#
FROM ubuntu:22.04
ENV CONTROLLER_IMAGE=ghcr.io/msciabarra/openwhisk-standalone
ENV CONTROLLER_TAG=0.3.0-morpheus.22092015
...
ADD run.sh dbinit.sh cron.sh pyproject.toml poetry.lock cli.sh profile.ipy Dockerfile /home/nuvolaris/
